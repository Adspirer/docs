---
title: "Google Display Ads Integration | Adspirer"
description: "Create and manage Google Display Network campaigns with AI: standard Display, Smart Display, audiences, topics, placements, and frequency caps."
icon: "image"
tag: "New"
...
- [Amazon Ads Integration](/ad-platforms/amazon-ads) — Retail / e-commerce PPC
- [ChatGPT Ads Integration](/ad-platforms/chatgpt-ads) — Ads inside ChatGPT
- [Campaign Creation Workflows](/agent-skills/workflows)
- [Pricing & Plans](https://www.adspirer.com/pricing)
- [Prompt Engineering Playbook](/agent-skills/prompt-engineering-playbook) — A custom skill, dossier, and prompt book generated from your Google Ads account (Display included) ($39 one-time)
