...
<AccordionGroup>
  ...
  <Accordion title="How much does Adspirer cost for Meta Ads?">
    Adspirer pricing is based on tool calls, not ad spend. Free tier: 10 calls/month. Plus: $25/mo for 50 calls. Pro: $75/mo for 100 calls. A typical Meta campaign creation uses 4-6 tool calls. See [full pricing](https://www.adspirer.com/pricing?utm_source=docs&utm_medium=page&utm_content=pricing).
  </Accordion>
</AccordionGroup>
