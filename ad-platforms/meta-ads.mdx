...
description: "Manage Facebook and Instagram campaigns with Adspirer's 21 MCP tools. Create image, video, and carousel ads, detect creative fatigue, optimize audiences, and analyze performance across Meta placements."
icon: "image"
