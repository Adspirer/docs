...
description: "Manage Google Search, Performance Max, Display, YouTube, and Demand Gen campaigns with AI. 90+ tools for keyword research, ad copy generation, performance analysis, and budget optimization."
...
- `get_campaign_targeting` -- View location and language targeting on existing campaigns
