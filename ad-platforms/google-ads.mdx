---
title: "Google Ads Integration | Adspirer"
description: "Manage Google Search, Performance Max, Shopping, App, Display, YouTube, and Demand Gen campaigns with AI — 147 tools for keywords, ad copy, and optimization."
icon: "magnifying-glass-dollar"
keywords: ["google ads", "search ads", "pmax", "shopping ads", "app campaigns", "display ads", "gdn", "keyword research", "google adwords", "ppc", "sem", "merchant center"]
---

# Google Ads Integration

The most comprehensive ad platform integration. Create Search, Performance Max, Shopping, App, Display, YouTube, and Demand Gen campaigns, research keywords with real CPC data, generate ad copy, and optimize performance with 147 specialized tools — including Manager-parity deep management down to the ad-group, asset-group, and product-partition level.
...
- `update_bid_strategy` -- Change a campaign's bidding strategy (Maximize Conversions, Target CPA, Target ROAS, Maximize Clicks, etc.). Detects shared **portfolio** bid strategies and explains how to change them; surfaces Smart Bidding prerequisites when conversion data is missing.
...
Sitelinks, callouts, and structured snippets each have full add / remove / list coverage. Ask for "extensions" or "ways to make my ads better" and Adspirer suggests sitelinks first (the highest-impact extension) — you don't have to know the term.
...
- `list_campaign_extensions` -- List the sitelinks, callouts, and structured snippets currently on a campaign
...
### Display Campaigns <Badge color="green">New</Badge>
...
**When to use:** Retargeting website visitors, brand awareness, local businesses beyond Search, visual storytelling with image + video creative. → [Full Display Ads guide](/ad-platforms/google-display-ads)

### YouTube Campaigns

Video ads on YouTube (In-Feed, In-Stream, Shorts). Uses Demand Gen format with YouTube-only channel controls.

**When to use:** Video-first creative, product demos, brand storytelling. → [Full YouTube Ads guide](/ad-platforms/youtube-ads)

### Shopping Campaigns <Badge color="green">New</Badge>
...
### App Campaigns <Badge color="green">New</Badge>
...
<Prompt description="Add search themes to an existing PMax campaign to guide targeting." actions={["copy", "cursor"]}>
...
<Prompt description="Find and add audience signals to a PMax campaign for better targeting." actions={["copy", "cursor"]}>
...
<Prompt description="Link Merchant Center and launch a Standard Shopping campaign with a product partition tree." actions={["copy", "cursor"]}>
...
If you're calling Adspirer over HTTP, the [research keywords API](/api-reference/google-ads/research-keywords) returns the same Keyword Planner data programmatically, and the [benchmark context API](/api-reference/google-ads/get-benchmark-context) supplies industry CPC and CTR baselines to compare those keywords against.
...
<Accordion title="When should I use Display instead of Performance Max?">
Use **[Display](/ad-platforms/google-display-ads)** when you want precise control — specific audiences, specific websites, specific keywords — or for retargeting website visitors. Display runs on the Display Network only (2M+ sites and apps).
...
<Accordion title="What are PMax search themes and audience signals?">
...
- [Google Display Ads Integration](/ad-platforms/google-display-ads) — Display Network, retargeting, Smart Display
- [YouTube Ads Integration](/ad-platforms/youtube-ads) — Video campaigns on YouTube
...
- [Prompt Engineering Playbook](/agent-skills/prompt-engineering-playbook) — A custom skill, dossier, and prompt book generated from your Google Ads account ($39 one-time)
