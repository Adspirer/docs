...
description: "Manage Google Search, Performance Max, Display, YouTube, and Demand Gen campaigns with AI — 95 tools for keywords, ad copy, and optimization."
icon: "magnifying-glass-dollar"
keywords: ["google ads", "search ads", "pmax", "display ads", "gdn", "keyword research", "google adwords", "ppc", "sem"]
---

# Google Ads Integration

The most comprehensive ad platform integration. Create Search, Performance Max, Display, YouTube, and Demand Gen campaigns, research keywords with real CPC data, generate ad copy, and optimize performance with 95 specialized tools.
