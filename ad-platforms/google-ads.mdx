...
All performance tools accept `raw_data: true` to return clean JSON metrics without recommendations or commentary. Ask for "raw data", "just the numbers", or "no recommendations" and your AI client will pass the flag automatically.
...
<Prompt description="Get raw performance data as JSON without recommendations." actions={["copy", "cursor"]}>
Give me raw data for my Google Ads campaigns over the last 30 days.
Just the numbers — spend, clicks, impressions, conversions, CPA, ROAS by campaign. No recommendations.
</Prompt>
