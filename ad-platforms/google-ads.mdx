...
description: "Manage Google Search, Performance Max, Display, YouTube, and Demand Gen campaigns with AI. 60+ tools for keyword research, ad copy generation, performance analysis, and budget optimization."
...
The most comprehensive ad platform integration. Create Search, Performance Max, Display, YouTube, and Demand Gen campaigns, research keywords with real CPC data, generate ad copy, and optimize performance with 60+ specialized tools.
...
- `get_campaign_targeting` -- View location targeting on existing campaigns
