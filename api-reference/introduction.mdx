...
Not yet. For "run every X hours" style jobs, use `create_monitor` — it polls on our side and emits alerts you can wire into Slack or email. For true push-based webhooks, [book a call](https://www.adspirer.com/book-demo?utm_source=docs&utm_medium=api-reference&utm_content=faq-webhooks).
</Accordion>
