---
title: "Adspirer REST API for Ads Automation"
sidebarTitle: "REST API Overview"
description: "HTTP access to Adspirer's 400+ tools. Create campaigns and pull performance for Google, Meta, Amazon, ChatGPT, LinkedIn, and TikTok Ads from n8n, Zapier, or Make."
icon: "code"
...
- [Tool Catalog](/agent-skills/tools) — the full 400+ tool reference
