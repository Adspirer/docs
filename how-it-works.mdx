...
- **Tool discovery:** Your AI client discovers Adspirer's 300+ tools with descriptions and parameters
...
This single URL gives access to all 300+ tools across all 6 ad platforms. Your AI client doesn't need to know about Google Ads APIs, Meta APIs, or LinkedIn APIs — Adspirer handles all of that behind the MCP layer.
...
- [Tool Catalog](/agent-skills/tools) — All 300+ tools
