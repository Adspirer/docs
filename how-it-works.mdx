...
- **Tool discovery:** Your AI client discovers Adspirer's 190+ tools with descriptions and parameters
...
This single URL gives access to all 190+ tools across all 4 ad platforms. Your AI client doesn't need to know about Google Ads APIs, Meta APIs, or LinkedIn APIs — Adspirer handles all of that behind the MCP layer.
...
- [Tool Catalog](/agent-skills/tools) — All 190+ tools
