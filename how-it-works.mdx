...
description: "End-to-end architecture of Adspirer — how your AI assistant connects to ad platforms via MCP, plus the OAuth flow, tool execution, and safety model."
