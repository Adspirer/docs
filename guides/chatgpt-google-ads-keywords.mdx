...
keywords: ["keyword research", "google ads keywords", "chatgpt", "cpc", "search volume"]
---
...
- Dynamic <Tooltip tip="Cost Per Click — amount you pay each time someone clicks your ad">CPC</Tooltip> thresholds automatically adapt to your industry (legal keywords at $50 CPC vs. retail at $2)
...
|--------------|-----------|-------|
| <Badge color="red">HIGH</Badge> | ≥75th percentile CPC | Top 25% most expensive keywords = highest commercial value |
| <Badge color="yellow">MEDIUM</Badge> | 25th-75th percentile | Middle 50% |
| <Badge color="green">LOW</Badge> | Less than 25th percentile | Bottom 25%, lower commercial intent |
