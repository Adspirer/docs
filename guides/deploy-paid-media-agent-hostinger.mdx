...
| **Adspirer Plugin** | The advertising brain — 300+ tools for Google Ads, Meta Ads, Amazon Ads, ChatGPT Ads, LinkedIn Ads, and TikTok Ads |
...
<Steps>
  ...
  <Step title="Install the Adspirer Plugin">
    ...
    This downloads the Adspirer plugin — including 300+ advertising tools and a built-in instruction manual (SKILL.md) that teaches your agent how to manage campaigns like an expert.
  </Step>
  ...
  <Step title="Restart the Gateway">
    ...
    This loads the Adspirer plugin and registers all 300+ tools. Your agent is now an advertising expert.
  </Step>
...
- **300+ tools documented** — every parameter, every return value
