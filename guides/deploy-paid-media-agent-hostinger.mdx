...
| **Adspirer Plugin** | The advertising brain — 190+ tools for Google Ads, Meta Ads, LinkedIn Ads, and TikTok Ads |
...
<Steps>
  ...
  <Step title="Install the Adspirer Plugin">
    ...
    This downloads the Adspirer plugin — including 190+ advertising tools and a built-in instruction manual (SKILL.md) that teaches your agent how to manage campaigns like an expert.
  </Step>
  ...
  <Step title="Restart the Gateway">
    ...
    This loads the Adspirer plugin and registers all 190+ tools. Your agent is now an advertising expert.
  </Step>
...
- **190+ tools documented** — every parameter, every return value
