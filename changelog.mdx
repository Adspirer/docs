...
<Update label="April 12, 2026" description="v2.15.2" tags={["Pricing", "Account Management"]}>

## Ad account limits by plan

Active ad account limits are now enforced per platform based on your subscription tier. Free, Plus, and Pro plans include 1 active account per platform. Max includes 2. Enterprise plans scale up to 50–200.

You can still connect as many accounts as you manage — the limit applies to how many are active simultaneously. If you exceed your plan's limit, you'll see a clear message with your current allowance and a link to upgrade.

See [Pricing](/knowledge-base/pricing) and [Multi-Account Management](/knowledge-base/multi-account) for details.
