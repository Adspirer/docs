...
Adspirer now supports **ChatGPT Ads (OpenAI Ads)** — pay-per-click "chat card" ads that render inside ChatGPT responses. Launch and manage them conversationally from ChatGPT, Claude, or any connected AI client.
...
- **Launch by describing the ad** — destination URL, headline, body, an image, a daily budget, and a location. Adspirer builds the campaign, ad group, and chat-card ad for you.
- **Paused by default, confirm to spend.** Nothing serves until you activate, and activation echoes the dollar-per-day budget for your explicit OK.
...
- **Conversions** via the OpenAI pixel and Conversions API.
