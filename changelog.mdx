...
<Update label="April 8, 2026" description="v2.15.2" tags={["Pricing", "Max Plan"]}>

## Unlimited tool calls on Max plan

The Max plan ($199/mo) now includes **unlimited tool calls** — no monthly cap. Previously limited to 3,000 calls/month, Max users can now run as many tool calls as they need without worrying about hitting a quota. All other plans remain unchanged.
