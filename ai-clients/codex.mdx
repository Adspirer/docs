...
- [Prompt Engineering Playbook](/agent-skills/prompt-engineering-playbook) — A custom skill and prompt book generated from your own ad account; drop it in `.agents/skills/` and `AGENTS.md` at the repo root ($39 one-time)
