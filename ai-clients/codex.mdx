...
When you connect Codex to Adspirer, you get 190+ advertising tools that run on a schedule. It's an AI ad manager that operates 24/7.
...
<Steps>
  ...
  <Step title="Add the Adspirer Marketplace">
    ...
    **Option A — type this directly in the Codex prompt:**
    ...
    <Frame caption="Codex runs the marketplace add command and confirms the install path">
      <img src="/images/codex/marketplace-add.png" alt="Codex running codex plugin marketplace add amekala/ads-mcp and confirming adspirer-marketplace added" />
    </Frame>
  ...
  <Step title="Find and Install Adspirer Ads Agent">
    ...
    <Frame caption="Plugin browser — Adspirer tab showing Adspirer Ads Agent as Available">
      <img src="/images/codex/plugin-list-available.png" alt="Codex plugin browser Adspirer tab with Adspirer Ads Agent available" />
    </Frame>

    Press **Enter** to open the plugin detail view. You'll see the 5 skills, MCP server (`adspirer`), and an **Install plugin** option.

    <Frame caption="Plugin detail view — skills, MCP server, and Install plugin option">
      <img src="/images/codex/plugin-detail.png" alt="Adspirer Ads Agent detail view showing 5 skills, adspirer MCP server, and Install plugin option" />
    </Frame>
  ...
  <Step title="Authorize with Adspirer">
    ...
    <Frame caption="Adspirer OAuth — review and authorize the requested scopes">
      <img src="/images/codex/oauth-authorize.png" alt="Adspirer OAuth authorization page showing Codex requesting campaigns:read, campaigns:write, performance:read, accounts:read" />
    </Frame>

    Return to your terminal — you'll see *"Installed Adspirer Ads Agent plugin."* The plugin now appears as **Installed** in `/plugins`.

    <Frame caption="Adspirer Ads Agent installed — visible in the Installed tab">
      <img src="/images/codex/plugin-installed.png" alt="Codex plugin browser showing Adspirer Ads Agent as Installed with checkmark" />
    </Frame>
  </Step>
...
|-------|-----------|-------------|
| **Adspirer Ads** | `$adspirer-ads` or just ask naturally | Full campaign management — 190+ tools, all workflows, all platforms |
...
190+ tools across 4 ad platforms, available for autonomous or on-demand tasks:
