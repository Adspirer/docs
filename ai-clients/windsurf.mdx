...
<Steps>
  ...
  <Step title="Try It Now">
    <Card
      ...
      icon="rocket"
      href="https://adspirer.ai/sign-up?utm_source=docs&utm_medium=setup-cta&utm_content=windsurf"
      horizontal
    >
...
### OAuth flow not opening or not triggering

**Most common cause:** You're already logged into [adspirer.ai](https://adspirer.ai) in your browser. Log out of Adspirer first, then retry authentication. The OAuth flow doesn't trigger when you have an active browser session — this is a known issue with CLI/IDE clients.
