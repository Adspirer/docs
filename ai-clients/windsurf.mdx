...
description: "Connect Windsurf IDE to Adspirer MCP via streamable HTTP config. Manage Google, Meta, Amazon, ChatGPT Ads, LinkedIn, and TikTok Ads from Codeium's AI editor with 400+ tools."
