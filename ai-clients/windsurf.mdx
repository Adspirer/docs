...
description: "Connect Windsurf IDE to Adspirer MCP via streamable HTTP. Manage Google, Meta, LinkedIn, and TikTok Ads from Codeium's AI editor with 190+ tools."
