...
description: "Connect Windsurf IDE to Adspirer MCP via streamable HTTP config. Manage Google, Meta, LinkedIn, and TikTok Ads from Codeium's AI editor with 190+ tools."
icon: "/icons/windsurf.svg"
keywords: ["windsurf", "codeium", "ide", "mcp"]
---

Manage ads from Windsurf without leaving your editor. 190+ tools, same workflow.
...
<Check>
You're connected. Windsurf now has access to 190+ advertising tools from the AI chat panel.
</Check>

## What You Can Do

190+ tools across 4 ad platforms, accessible from Windsurf's AI chat:
