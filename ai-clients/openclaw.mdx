...
**First check:** Are you logged into [adspirer.ai](https://adspirer.ai) in your browser? Log out first — being logged in blocks the OAuth flow for CLI clients.
...
Adspirer pricing is based on tool calls, not ad spend. Free tier: 10 calls/month. Plus: $25/mo for 50 calls. Pro: $75/mo for 100 calls. See [full pricing details](https://www.adspirer.com/pricing?utm_source=docs&utm_medium=page&utm_content=pricing).
</Accordion>
</AccordionGroup>
