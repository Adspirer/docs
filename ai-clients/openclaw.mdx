  ...
  <Tab title="Hostinger VPS">
    ...
    <Steps>
      <Step title="Buy a Hostinger VPS with OpenClaw">
        Go to [Hostinger's VPS marketplace](https://www.hostinger.com/vps/docker/openclaw), select a plan, and click **Deploy**. OpenClaw is auto-selected as the pre-installed application.
      </Step>
