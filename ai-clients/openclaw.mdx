...
One plugin, 190+ tools, 14KB skill file built in. No separate setup.

## What Makes OpenClaw Different

Every other MCP client gives you access to Adspirer's 190+ tools. That's the baseline.
  ...
  <Tab title="Local Install">
    ...
    <Steps>
      ...
      <Step title="Install the Adspirer Plugin">
        ...
        This installs the plugin with all 190+ tools and the 14.4KB SKILL.md instruction file bundled in. No separate skill or agent installation needed.
      </Step>
...
- **190+ tools documented:** Every parameter, every return value, every edge case
