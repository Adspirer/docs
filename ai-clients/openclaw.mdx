  ...
  <Step title="Authenticate with Adspirer">
    <Tabs>
      <Tab title="Local (Browser)">
        ...
        Your browser opens for OAuth 2.1 sign-in. Authorize OpenClaw to access your Adspirer account. No passwords stored locally.
      </Tab>
      <Tab title="Remote Server (API Key)">
        Generate a Personal Access Token at [adspirer.ai/keys](https://adspirer.ai/keys), then authenticate:
        ...
        See [Remote Server Setup](#remote-server-setup) for Docker, CI/CD, and more options.
      </Tab>
    </Tabs>
  </Step>
