...
description: "Connect Perplexity to Adspirer via MCP connector. Manage Google Ads, Meta Ads, LinkedIn Ads, and TikTok campaigns with 190+ tools from Perplexity Computer — the autonomous AI agent."
...
Search-powered ad management. Connect Adspirer to Perplexity Computer and combine real-time web research with 190+ advertising tools across Google Ads, Meta Ads, LinkedIn Ads, and TikTok Ads.
...
<Steps>
  ...
  <Step title="Add the Adspirer Skill (Recommended)">
    Skills teach Perplexity Computer the *right way* to use Adspirer's 190+ tools — which tools to call first, how to validate data before creating campaigns, when to ask for confirmation. Without a skill, Computer guesses the tool order. With it, Computer follows proven advertising workflows.
  ...
  <Step title="Start Managing Ads">
    Go back to Perplexity Computer and start a new task. Adspirer's 190+ tools are now available:
