...
description: "Connect Perplexity to Adspirer via MCP connector. Manage Google, Meta, Amazon, ChatGPT Ads, LinkedIn, and TikTok Ads with 400+ tools from Perplexity Computer's AI agent."
...
|----------|-------|-----------------|
| **Google Ads** | 147 | Keyword research with real CPC data, Search & PMax campaigns, wasted spend analysis, budget optimization |
| **Amazon Ads** | 61 | Sponsored Products, Brands & Display, ASIN/keyword targeting, ACOS & ROAS analytics, budget recommendations |
| **Meta Ads** | 54 | Image/video/carousel campaigns, audience targeting, creative fatigue detection |
...
- [Prompt Engineering Playbook](/agent-skills/prompt-engineering-playbook) — A custom skill and prompt book generated from your own ad account; paste its agent instructions into your Space ($39 one-time)
