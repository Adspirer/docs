---
title: "Connect Perplexity to Ad Platforms | Adspirer"
sidebarTitle: "Perplexity"
description: "Connect Perplexity to Adspirer via MCP connector. Manage Google, Meta, Amazon, ChatGPT Ads, LinkedIn, and TikTok Ads with 300+ tools from Perplexity Computer's AI agent."
...
Search-powered ad management. Connect Adspirer to Perplexity Computer and combine real-time web research with 300+ advertising tools across Google Ads, Meta Ads, Amazon Ads, ChatGPT Ads, LinkedIn Ads, and TikTok Ads.
...
<Steps>
  ...
  <Step title="Add the Adspirer Skill (Recommended)">
    Skills teach Perplexity Computer the *right way* to use Adspirer's 300+ tools — which tools to call first, how to validate data before creating campaigns, when to ask for confirmation. Without a skill, Computer guesses the tool order. With it, Computer follows proven advertising workflows.
  ...
  <Step title="Start Managing Ads">
    Go back to Perplexity Computer and start a new task. Adspirer's 300+ tools are now available:
...
300+ tools across 6 ad platforms:
