---
title: "Connect Gemini CLI to Ad Platforms | Adspirer"
sidebarTitle: "Gemini CLI"
description: "Connect Gemini CLI to Adspirer MCP in 2 minutes. Manage Google Ads, Meta Ads, Amazon Ads, ChatGPT Ads, LinkedIn Ads, and TikTok Ads from your terminal with 300+ tools."
icon: "/icons/gemini.svg"
keywords: ["gemini cli", "gemini", "google", "terminal", "cli", "mcp", "extension"]
---

Manage all your ad campaigns from the terminal using Google's Gemini CLI. One command to install, 300+ tools to use.
...
<Check>
You're connected. Gemini CLI now has access to 300+ advertising tools from your terminal.
</Check>
...
Both are terminal-based AI tools that connect to Adspirer via MCP. Gemini CLI is powered by Google's Gemini model. Claude Code is powered by Anthropic's Claude model. Both have full access to the same 300+ advertising tools. Choose whichever AI model you prefer.
</Accordion>
