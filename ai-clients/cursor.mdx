---
title: "Connect Cursor to Ad Platforms | Adspirer"
sidebarTitle: "Cursor"
description: "Connect Cursor IDE to Adspirer MCP. Manage Google, Meta, Amazon, ChatGPT Ads, LinkedIn, and TikTok Ads from your editor with 340+ tools, 5 skills, and a marketing subagent."
icon: "/icons/cursor.svg"
keywords: ["cursor", "ide", "mcp", "cursor ai", "code editor"]
---

Manage ads from your code editor. One command to install, 340+ tools, automatic workflow rules, zero context-switching.
...
<Check>
You're connected. Cursor now has access to 340+ advertising tools with automatic workflow enforcement.
</Check>
...
340+ tools across 6 ad platforms, accessible from Cursor's AI chat or inline editing:
