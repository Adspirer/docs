...
description: "Connect Manus AI to Adspirer MCP. Manage Google, Meta, LinkedIn, and TikTok Ads from Manus with 190+ tools, autonomous research, scheduled briefs, and interactive dashboards."
icon: "/icons/manus.svg"
sidebarTitle: "Manus"
keywords: ["manus", "manus ai", "manus mcp", "autonomous agent", "dashboard", "api key"]
---

Autonomous ad management with deep research. Manus connects to Adspirer as a custom MCP server, giving it 190+ advertising tools across Google Ads, Meta Ads, LinkedIn Ads, and TikTok Ads.
...
<CardGroup cols={2}>
  ...
  <Card title="Explore All Tools" icon="wrench" href="/agent-skills/tools">
    Browse the full catalog of 190+ advertising tools available through Manus.
  </Card>
