...
<Steps>
  <Step title="Open Claude Connectors">
    ...
    Or navigate manually: **Settings → Connectors** in Claude. You need a Pro, Max, Team, or Enterprise subscription to access connectors.
  </Step>
  <Step title="Add Custom Connector">
    Click **Add custom connector** (or [open this direct link](https://claude.ai/settings/connectors?modal=add-custom-connector)) and enter:
