...
sidebarTitle: "Claude"
description: "Connect Claude Desktop or claude.ai to Adspirer via MCP connector. Manage Google, Meta, Amazon, ChatGPT, LinkedIn, and TikTok Ads with 400+ tools using natural language."
...
For developer/terminal setup, see the full [Claude Code Setup Guide](/ai-clients/claude-code). One command installs the MCP connector along with slash commands, skills, and an agent:
...
- [Prompt Engineering Playbook](/agent-skills/prompt-engineering-playbook) — A custom skill, dossier, and prompt book generated from your own ad account ($39 one-time)
