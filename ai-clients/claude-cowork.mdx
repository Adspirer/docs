...
description: "Connect Claude Cowork (Claude's desktop app workspace mode — not the terminal CLI) to Adspirer. Manage Google, Meta, Amazon, ChatGPT, LinkedIn, and TikTok Ads with 300+ tools, brand-aware skills, and a marketing agent."
...
This page is for **Claude Cowork** — Claude's brand-aware advertising workspace. Connect Adspirer and you get 300+ ad management tools the agent can call against your Google, Meta, Amazon, ChatGPT Ads, LinkedIn, and TikTok accounts, all grounded in the brand folder you point Cowork at.
...
<Steps>
  ...
  <Step title="Review Plugin Contents">
    ...
    **Agents** — A Performance Marketing Agent that specializes in using Adspirer's 300+ tools
  ...
  <Step title="Authenticate with Adspirer">
    ...
    Once authorized, the connector status flips to **connected** with all 300+ tools listed under tool permissions.
...
<Check>
You're connected. Claude Cowork now has access to 300+ advertising tools, brand-aware skills, and a Performance Marketing Agent that knows how to use them in the right order.
</Check>
...
| **ChatGPT Ads** | Conversational | Launch & manage pay-per-click chat-card ads inside ChatGPT, paused by default |
...
- **Plugin Ecosystem** — The Adspirer plugin ships 5 slash commands, two skills, and a Performance Marketing Agent that knows how to use all 300+ Adspirer tools in the right order with safety rules — all installed in one click from Browse Plugins.
