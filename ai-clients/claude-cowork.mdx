...
| **How you connect Adspirer** | Browse Plugins → Install Adspirer in **Customize** (this page) | `/plugin install adspirer-ads-agent@claude-community` (recommended), or manual `claude mcp add ...` |
