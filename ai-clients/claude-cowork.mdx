...
<Check>
You're connected. Claude Cowork now has access to 190+ advertising tools, brand-aware skills, and a Performance Marketing Agent that knows how to use them in the right order.
</Check>
...
- **Plugin Ecosystem** — The Adspirer plugin ships 5 slash commands, two skills, and a Performance Marketing Agent that knows how to use all 190+ Adspirer tools in the right order with safety rules — all installed in one click from Browse Plugins.
