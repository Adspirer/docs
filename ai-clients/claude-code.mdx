...
<Tip>
**Adspirer is available on the Claude plugin marketplace.** Run `/plugin` in Claude Code, open the **Discover** tab, and search for `adspirer` — you'll find `adspirer-ads-agent` from `claude-community`. No custom marketplace setup required.
</Tip>
...
<Steps>
  <Step title="Search and Install the Plugin">
    ...
    <Frame caption="Adspirer in the Discover tab of the claude-community marketplace">
      <img src="/images/claude-code/plugin-discover-search.png" alt="Plugin Discover tab showing adspirer-ads-agent from claude-community" />
    </Frame>
