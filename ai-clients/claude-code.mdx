...
description: "Connect Claude Code to Adspirer MCP in 2 minutes. Manage Google Ads, Meta Ads, LinkedIn Ads, and TikTok Ads from your terminal with 190+ tools."
icon: "/icons/claude-code.svg"
keywords: ["claude code", "terminal", "cli", "mcp", "plugin"]
---

Manage all your ad campaigns from the terminal. One command to connect, 190+ tools to use.
...
<Note>
**Plugin discovery has been removed from the terminal CLI in some recent Claude Code builds.** If `/plugin` doesn't surface Adspirer in your shell, use the **Manual MCP Setup** tab — same 190+ tools, just without the slash commands. The plugin path still works on Claude Code desktop / IDE-side.
...
<Check>
You're connected. Claude Code now has access to 190+ advertising tools from your terminal.
</Check>
...
190+ tools across 4 ad platforms. Here's what matters:
