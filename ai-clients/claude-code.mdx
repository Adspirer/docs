...
<Steps>
  ...
  <Step title="Authenticate with Adspirer">
    ...
    **From the plugin manager (recommended):** type `/plugin`, open the **Installed** tab, and select **adspirer**. You'll see **Plugin:adspirer-ads-agent:adspirer MCP Server** with status "needs authentication". Choose **Authenticate** — your browser opens for OAuth sign-in.
