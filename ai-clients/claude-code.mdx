...
<Steps>
  <Step title="Install the Plugin">
    ...
    This installs the MCP server, slash commands, agent, and skills in one step.
  </Step>
  <Step title="Authenticate with Adspirer">
    Run `/mcp` in Claude Code and find **plugin:adspirer:adspirer** in the list. Click to authenticate — your browser opens for OAuth 2.1 sign-in. Sign in, connect your ad platforms, return to Claude Code.
  </Step>
