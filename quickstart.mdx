    ...
    **Quick MCP Config Reference**
    ...
    <Tabs>
      <Tab title="Claude Code">
        ...
        ```
        Or use the plugin system: `/plugin install adspirer-ads-agent@claude-community` (Anthropic community marketplace — enabled by default, no setup needed)
      </Tab>
      <Tab title="Cursor">
        ```bash
...
<CardGroup cols={2}>
  ...
  <Card title="Tool Catalog" icon="wrench" href="/agent-skills/tools">
    Browse all 340+ tools organized by platform.
  </Card>
</CardGroup>
