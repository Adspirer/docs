---
title: "Quickstart"
description: "Get started with Adspirer in under 5 minutes. Sign up, connect your AI client (ChatGPT, Claude, Claude Code, Gemini CLI, Cursor, Codex, OpenClaw, Windsurf, or Perplexity), link an ad platform, and run your first campaign query."
icon: "rocket"
    ...
    **Quick MCP Config Reference**
    ...
    <Tabs>
      <Tab title="Claude Code">
        ...
        ```
        Or use the plugin system: `/plugin install adspirer-ads-agent@claude-plugins-official` (official Anthropic marketplace — no setup needed)
      </Tab>
      <Tab title="Cursor">
        ```bash
