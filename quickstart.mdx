  ...
  <Step title="Connect an Ad Platform">
    ...
    <CardGroup cols={2}>
      <Card title="Google Ads" icon="/icons/google-ads.svg" href="/ad-platforms/google-ads">
        95 tools for Search & PMax campaigns, keyword research, budget optimization.
      </Card>
      <Card title="Meta Ads" icon="/icons/meta.svg" href="/ad-platforms/meta-ads">
        37 tools for Facebook & Instagram campaigns, creative testing.
      </Card>
      ...
      <Card title="ChatGPT Ads" icon="/icons/openai.svg" href="/ad-platforms/chatgpt-ads">
        Pay-per-click ads rendered inside ChatGPT — launch and manage by chat.
      </Card>
      <Card title="LinkedIn Ads" icon="/icons/linkedin.svg" href="/ad-platforms/linkedin-ads">
        45 tools for B2B advertising, lead gen forms, sponsored content.
      </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Tool Catalog" icon="wrench" href="/agent-skills/tools">
    Browse all 300+ tools organized by platform.
  </Card>
</CardGroup>
