...
description: "How Adspirer implements the Model Context Protocol (MCP). Architecture, OAuth 2.1 with PKCE, streamable HTTP transport, tool discovery, and the security model."
