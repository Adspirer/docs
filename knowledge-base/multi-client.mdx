...
description: "Use the same Adspirer account with ChatGPT, Claude, Claude Code, Gemini CLI, Cursor, Codex, OpenClaw, Windsurf, Perplexity, and Manus. One account, one tool call limit, any AI client."
icon: "users"
