...
description: "Use one Adspirer account with ChatGPT, Claude, Cursor, Codex, Gemini CLI, OpenClaw, Windsurf, Perplexity, and Manus — one tool call limit, any AI client."
icon: "users"
