...
<AccordionGroup>
  ...
  <Accordion title="Do I need to install anything?">
    ...
    - **Claude Code:** One command (`/plugin install adspirer-ads-agent@claude-plugins-official`) — available on the official Anthropic plugin marketplace. [Guide →](/ai-clients/claude-code)
