...
<AccordionGroup>
  ...
  <Accordion title="What is MCP?">
    ...
    Adspirer implements MCP so that any AI client — Claude, ChatGPT, Perplexity, Cursor, Codex — can access the same 190+ advertising tools through one connection. See [How MCP Works](/mcp).
  </Accordion>
