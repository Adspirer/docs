...
| **Tool Calls** | 3,000/month (or 50,000/yr annual) | Unlimited | Unlimited |
| **Seats** | 1 | 5 (minimum) | 10 |
| **Total Ad Accounts** | Up to 50 | Up to 50 | 200+ |
| **Sequential Subagents** | Across 50 accounts | Across 50 accounts | Across 200+ accounts |
...
On **Max**, you're an individual marketer with **3,000 tool calls/month** (or 50,000/year on the annual plan), up to 50 total ad accounts active simultaneously, and sequential subagents that automate across all of them in a single session.
...
A single enterprise ad account can contain thousands of campaigns, millions of keywords, and years of performance history. The infrastructure cost scales with accounts, not just tool calls. That's why Max includes up to 50 active accounts, and Enterprise Plus scales up to 200+.

<Tip>
**Max (up to 50 active accounts)** is ideal for a solo marketer or boutique agency managing multiple brands or platforms with sequential subagents. **Enterprise** is for larger teams managing many clients — each planner gets their own seat, with pooled tool calls and dedicated support.
</Tip>
...
|------|-------------------|--------------------------|
| <Badge color="yellow">Max</Badge> | Up to 50 | Across 50 accounts |
| <Badge color="green">Enterprise</Badge> | Up to 50 | Across 50 accounts |
...
| 10+ planners | 200+ | Custom | [Contact us](https://www.adspirer.com/book-demo) |
...
<Warning>
Custom integrations are in active development. GA4 and GCS are available now for Enterprise Plus clients. X and Pinterest Ads are on the near-term roadmap — [contact us](https://www.adspirer.com/book-demo) for current availability.
</Warning>
...
| Large agency | 10+ | 200+ | Custom | [Contact us](https://www.adspirer.com/book-demo) |
...
|------|-------|------------|
| <Badge color="yellow">Max</Badge> | 1 | 3,000/month (50,000/yr annual) |
