...
Adspirer Enterprise is built for agencies, holding companies, and large marketing teams that manage advertising across dozens or hundreds of client accounts. Enterprise layers add team management, account scale, and dedicated support on top of near-unlimited tool calls.
...
| **Tool Calls** | 3,000/month | Near-unlimited — fair-use policy | Near-unlimited — 1,000,000 pooled calls/yr |
...
5 to 20+ seats, each with their own login. Tool calls are near-unlimited and pooled across the team, so every planner works on their assigned accounts without hitting a personal cap.
</Card>
...
<Tip>
**Max (up to 5 active accounts)** is ideal for a solo marketer managing multiple brands or platforms with sequential subagents. **Enterprise** is for teams running campaigns across many accounts — each planner gets their own seat, with near-unlimited tool calls pooled across the team.
</Tip>

## How Enterprise Scale Works

All Enterprise plans include **near-unlimited tool calls**. The difference from Max is **account scale** and **sequential subagents**: Enterprise lets your team operate across dozens or hundreds of accounts from a single conversation.
...
| 10–20+ planners | Up to 200 | <Badge color="red">Enterprise Plus</Badge> | From $62,500/yr |
...
| Mid team | 10–20+ | Up to 200 | <Badge color="red">Enterprise Plus</Badge> | From $62,500/yr |
| Larger footprint | 20+ | 200+ | Custom | [Contact us](https://www.adspirer.com/book-demo) |
...
| <Badge color="green">Enterprise</Badge> | 5 (minimum) | Near-unlimited — fair-use policy |
| <Badge color="red">Enterprise Plus</Badge> | 20+, customizable | Near-unlimited — dedicated, 1,000,000 pooled calls/yr |
...
<Accordion title="Are tool calls really near-unlimited?">
Near-unlimited means an allowance large enough that your team never manages against it. Enterprise Plus includes 1,000,000 pooled tool calls a year across all seats — several times what a team of 20 planners typically uses. Calls are pooled across the team, so no individual planner hits a personal cap, and there are no per-call charges.
</Accordion>
