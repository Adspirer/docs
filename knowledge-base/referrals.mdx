...
You do not have to watch for this or chase them. **We email you the moment your 50 calls land.**
</Info>
...
Your link looks like `https://adspirer.ai/r/PWPD6RG`, where `PWPD6RG` is your personal referral code.
...
> **Subject:** Steven gave you 25 free tool calls on Adspirer
>
> **Steven** is running their performance marketing with AI agents, and wants you to try it — here's **25 free tool calls** on them.
>
...
> I'm using AI agents to run my performance marketing 🤖 Adspirer builds and optimises my campaigns across Google, Meta, TikTok and LinkedIn, inside Claude/ChatGPT. Here's 25 free tool calls to try it 👉 https://adspirer.ai/r/PWPD6RG
...
If you believe a genuine referral of yours was not credited, ask us through the chat assistant at [adspirer.ai](https://adspirer.ai) or email [abhi@adspirer.com](mailto:abhi@adspirer.com). We can see exactly why and put it right if we got it wrong.
</Accordion>
...
Use the chat assistant at [adspirer.ai](https://adspirer.ai), or email [abhi@adspirer.com](mailto:abhi@adspirer.com). Include the email address of the person you referred and roughly when they signed up, and we can tell you exactly which step it is sitting at.
