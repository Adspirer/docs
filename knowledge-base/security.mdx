...
description: "How Adspirer protects your ad accounts: OAuth 2.1 with PKCE, API key auth, no password storage, encrypted tokens, revocable access, and data handling policies."
icon: "shield-halved"
