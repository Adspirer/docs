---
title: "Adspirer Security: OAuth, Encryption & Data Privacy"
description: "How Adspirer protects your ad accounts: OAuth 2.1 with PKCE, API key auth, no password storage, encrypted tokens, and revocable access."
icon: "shield-halved"
