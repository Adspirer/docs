...
These limitations reflect the current API integrations. New capabilities are added regularly — see the [Changelog](/changelog) for updates. Custom integrations beyond the four core ad platforms — such as Google Analytics 4 and Slack — are available on the [Adspirer Enterprise plans for agencies and teams](/knowledge-base/enterprise).
