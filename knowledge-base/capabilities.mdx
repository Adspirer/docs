...
description: "Adspirer capabilities and limitations. What the AI ad agent handles (campaigns, analytics, optimization) and what it doesn't (creative generation, billing)."
icon: "list-check"
