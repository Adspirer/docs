...
- **[Prompt Engineering Playbook](/agent-skills/prompt-engineering-playbook)** — Adspirer reads one of your ad accounts and generates a custom agent skill, a written account dossier, a prompt book against your real campaigns, and paste-ready agent instructions. You download the files and install them in Claude, ChatGPT, Claude Code, Cowork, Cursor, or Codex.
