...
description: "Manage multiple ad accounts across Google, Meta, LinkedIn, and TikTok from one Adspirer connection. Max plan activates up to 50 accounts for sub-agent flows."
icon: "building"
