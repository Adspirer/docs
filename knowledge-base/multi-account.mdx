...
description: "Manage multiple ad accounts across Google, Meta, LinkedIn, and TikTok Ads from one Adspirer connection. Annual plans activate up to 5 accounts per platform."
icon: "building"
...
The cap is **per platform** — every plan counts Google Ads, Meta, LinkedIn, and TikTok independently. A Plus annual customer can activate up to 5 Google Ads accounts **and** 5 Meta accounts at the same time.
