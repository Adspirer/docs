...
description: "Manage multiple ad accounts across Google Ads, Meta Ads, LinkedIn Ads, and TikTok Ads from a single Adspirer connection. All plans support unlimited connected accounts — Free, Plus, and Pro work with one active account at a time, while Max activates up to 50 accounts simultaneously for sequential sub-agent workflows."
icon: "building"
...
- **Max** — up to 50 accounts active simultaneously. Sequential sub-agents fan out tool calls across all active accounts in a single conversation.
