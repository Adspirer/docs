...
Paid plans run **daily background metric collection** — Adspirer continuously syncs campaign structures, keywords, performance metrics, and budget data from your connected ad accounts. When you ask "what's my ROAS this week?" you get live data, not a stale snapshot.

| Plan | Data Sync | Historical Lookback |
|------|-----------|-------------------|
| <Badge>Free</Badge> | One-time at signup | 90 days (at signup) |
| <Badge color="blue">Plus</Badge> | Daily background sync | 90 days rolling |
| <Badge color="purple">Pro</Badge> | Daily background sync | 90 days rolling |
| <Badge color="yellow">Max</Badge> | Daily background sync | 90 days rolling |
| <Badge color="green">Enterprise</Badge> | Daily background sync | 12 months rolling |
