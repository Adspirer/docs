...
| <Badge color="yellow">Max</Badge> | 3,000 | $199/mo | $2,000/yr | Multi-platform, multi-account, sequential sub-agents |
...
|---|---|---|---|---|
| [**Prompt Engineering Playbook**](/agent-skills/prompt-engineering-playbook) | **$39** | **One time — nothing recurs** | **One ad account** | One free on annual plans |

The [Prompt Engineering Playbook](/agent-skills/prompt-engineering-playbook) generates a custom agent skill, an account dossier, a prompt book, and paste-ready agent instructions from **your** ad account's real campaigns and history. You download the files and install them in Claude, ChatGPT, Claude Code, Cowork, Cursor, or Codex. They're yours to keep, and rebuilding them against fresh data later is free and unlimited.
...
Because each playbook is generated on demand from your account, it's non-refundable once the build has completed and the files are available to download. Failed builds and accounts you can't access are a different matter — [contact support](/knowledge-base/support).
...
| Plan | Monthly | Annual |
|------|:-------:|:------:|
| <Badge>Free</Badge> | 1 | 1 |
| <Badge color="blue">Plus</Badge> | 1 | **5** |
| <Badge color="purple">Pro</Badge> | 1 | **5** |
| <Badge color="yellow">Max</Badge> | **5** | 5 |

The cap is **per platform** — a Plus annual customer can activate up to 5 Google Ads accounts **and** 5 Meta accounts **and** 5 LinkedIn accounts **and** 5 TikTok accounts at the same time. See [Multi-Account](/knowledge-base/multi-account) for how the agent fans out tool calls across active accounts.
...
| $50K+/mo ad spend, 10+ team members, or agency with multiple clients | [<Badge color="green">Enterprise</Badge>](/knowledge-base/enterprise) from $18,000/yr |
