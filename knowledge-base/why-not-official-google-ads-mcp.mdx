...
description: "What Google's free official Google Ads MCP server actually gets you when ChatGPT or Claude recommends it: GAQL-over-chat, read-only, Google-only."
