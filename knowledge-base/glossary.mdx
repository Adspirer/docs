...
An open standard created by Anthropic that allows AI assistants to connect to external tools and services. Adspirer uses MCP to give AI clients access to 340+ advertising tools. See [How MCP Works](/mcp).
