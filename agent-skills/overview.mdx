...
description: "Turn your AI assistant into an expert advertising manager. Skills teach AI the right workflow for using Adspirer's 190+ tools—research before creating, validate before launching, confirm before spending."
icon: "brain"
...
When you connect an AI assistant to Adspirer, it gains access to 190+ advertising tools. That's powerful. It's also overwhelming.
...
- **Tool reference:** Descriptions of all 190+ tools with parameters and use cases
...
**Option A: Plugin install (recommended)** — installs MCP server, skills, slash commands, and agent in one step. Available on the official Anthropic marketplace, no setup needed:
...
Complete reference of all 190+ tools with:
