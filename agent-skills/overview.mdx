...
|-----------|---------------|-----------------|
| [Claude Code](/ai-clients/claude-code) | Yes | `~/.claude/skills/ad-campaign-management/` |
| [Cursor](/ai-clients/cursor) | Yes + Cursor Rules | `~/.cursor/skills/` + `.cursor/rules/` |
| [Codex](/ai-clients/codex) | Yes + Agent YAML | `~/.codex/skills/adspirer-ads.md` |
