...
Go to **Customize → Skills** in Claude. Upload the [Adspirer SKILL.md](https://github.com/amekala/ads-mcp/blob/main/skills/ad-campaign-management/SKILL.md) content as a new skill. See the [Claude Setup Guide](/ai-clients/claude#add-the-adspirer-skill-optional) for step-by-step instructions.
...
<AccordionGroup>
  ...
  <Accordion title="Do skills work with ChatGPT and Claude web?">
    **Claude:** Yes. Go to **Customize → Skills** in Claude and upload the Adspirer skill. See the [Claude Setup Guide](/ai-clients/claude#add-the-adspirer-skill-optional) for instructions.
