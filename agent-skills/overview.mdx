---
title: "Agent Skills: AI Workflows for Ad Campaigns"
sidebarTitle: "Overview"
description: "Turn your AI assistant into an expert ad manager. Skills teach the right workflow for Adspirer's 340+ tools: research, validate, then launch safely."
icon: "brain"
...
When you connect an AI assistant to Adspirer, it gains access to 340+ advertising tools. That's powerful. It's also overwhelming.
...
- **Tool reference:** Descriptions of all 340+ tools with parameters and use cases
...
Complete reference of all 340+ tools with:
...
- [Tool Catalog](/agent-skills/tools) -- Full reference of all 340+ Adspirer tools
