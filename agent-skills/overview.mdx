...
|-----------|---------------|-----------------|
| [Claude Code](/ai-clients/claude-code) | Yes + Slash Commands | `~/.claude/skills/` (via plugin or manual) |
| [Cursor](/ai-clients/cursor) | Yes + Subagent + Rules | `~/.cursor/skills/` + `~/.cursor/agents/` |
| [Codex](/ai-clients/codex) | Yes + Agent Config | `~/.agents/skills/` + `~/.codex/agents/` |
| [OpenClaw](/ai-clients/openclaw) | Bundled (14.4KB SKILL.md) | Auto-installed with plugin |
| [Windsurf](/ai-clients/windsurf) | Coming soon | -- |
