...
description: "Turn your AI assistant into an expert ad manager. Skills teach the right workflow for Adspirer's 300+ tools: research, validate, then launch safely."
icon: "brain"
...
When you connect an AI assistant to Adspirer, it gains access to 300+ advertising tools. That's powerful. It's also overwhelming.
...
- **Tool reference:** Descriptions of all 300+ tools with parameters and use cases
...
Complete reference of all 300+ tools with:
...
- [Tool Catalog](/agent-skills/tools) -- Full reference of all 300+ Adspirer tools
