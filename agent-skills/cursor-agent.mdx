...
description: "How the Adspirer performance marketing agent works inside Cursor. Subagent architecture, 5 skills, Cursor Rules, memory, and the agent loop explained."
