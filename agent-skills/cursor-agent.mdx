...
|-----------|------|---------|
| **MCP Server** | `~/.cursor/mcp.json` | 190+ advertising tools via OAuth |
...
<AccordionGroup>
  ...
  <Accordion title="Can I use Adspirer in Cursor without the agent?">
    Yes. Just add the MCP server and you get 190+ tools directly. But without the agent, skills, and rules, you lose brand awareness, workflow enforcement, strategy persistence, and memory.
  </Accordion>
</AccordionGroup>
