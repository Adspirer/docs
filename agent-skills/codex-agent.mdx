...
description: "How the Adspirer performance marketing agent works in OpenAI Codex CLI. Agent config, 5 skills, safety rules, AGENTS.md, and the plan-execute-verify loop."
