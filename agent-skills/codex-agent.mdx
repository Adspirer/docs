---
title: "Run the Adspirer Marketing Agent in OpenAI Codex"
sidebarTitle: "Codex Agent"
description: "How the Adspirer performance marketing agent runs in OpenAI Codex CLI: agent config, 5 skills, safety rules, AGENTS.md, and the plan-execute-verify loop."
...
|-----------|------|---------|
| **MCP Server** | `~/.codex/config.toml` | 190+ advertising tools via OAuth |
