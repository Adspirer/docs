...
<AccordionGroup>
  ...
  <Accordion title="Does the agent work with ChatGPT?">
    Not yet. ChatGPT supports MCP connectors (tools) but not agent files, skills, or rules. You get the full 100+ tools but without workflow enforcement or brand awareness. [Perplexity](/ai-clients/perplexity) supports skill uploads (SKILL.md) for workflow guidance. The [Claude](/ai-clients/claude), [Claude Code](/ai-clients/claude-code), [Cursor](/ai-clients/cursor), and [Codex](/ai-clients/codex) integrations support the full agent experience.
  </Accordion>
