...
<Expandable title="View all 23 Meta Ads tools">
...
| `add_meta_ad_set` | <Badge color="red">Write</Badge> | Add ad set to existing campaign with targeting, budget, and creative (supports lifetime budgets, placement controls) |
| `add_meta_ad` | <Badge color="red">Write</Badge> | Add ad creative to existing ad set (supports multi-advertiser opt-out) |
