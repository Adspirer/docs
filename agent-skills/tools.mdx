...
description: "Complete reference of all 140+ Adspirer tools. Organized by platform (Google Ads, Meta Ads, LinkedIn Ads, TikTok Ads) with types, descriptions, and parameters."
icon: "wrench"
mode: "wide"
...
| `get_campaign_targeting` | <Badge color="green">Read</Badge> | View location targeting on existing campaigns |
...
<Expandable title="View all 36 Meta Ads tools">
...
| `get_meta_audience_insights` | <Badge color="green">Read</Badge> | Audience demographics, placement breakdown, and device targeting insights |
| `analyze_meta_wasted_spend` | <Badge color="green">Read</Badge> | Identify underperforming campaigns, placement waste, and creative fatigue |
...
| `create_meta_dco_ad` | <Badge color="red">Write</Badge> | Create Dynamic Creative Optimization ad — Meta auto-tests multiple images to find the best combination |
| `add_meta_ad_set` | <Badge color="red">Write</Badge> | Add ad set to existing campaign (image, video, carousel, DCO, CBO spend controls, custom conversions) |
| `add_meta_ad` | <Badge color="red">Write</Badge> | Add creative variation to an existing ad set |
| `list_meta_campaigns` | <Badge color="green">Read</Badge> | Browse all campaigns with status, budget, and objective |
| `get_meta_campaign_details` | <Badge color="green">Read</Badge> | Full campaign structure with ad sets, ads, targeting, and budgets |
| `list_meta_ad_sets` | <Badge color="green">Read</Badge> | View ad sets within a campaign with targeting and optimization settings |
| `list_meta_ads` | <Badge color="green">Read</Badge> | View individual ads within an ad set with status and creative info |
| `update_meta_campaign` | <Badge color="red">Write</Badge> | Change budgets, bids, or targeting |
| `update_meta_ad_set` | <Badge color="red">Write</Badge> | Edit ad set targeting, budget, bid, placements, schedule, or optimization |
| `update_meta_ad` | <Badge color="red">Write</Badge> | Update an ad — pause/resume, rename, or swap creative |
...
| `duplicate_meta_campaign` | <Badge color="red">Write</Badge> | Copy an existing campaign with all ad sets, ads, and settings |
| `list_meta_instagram_accounts` | <Badge color="green">Read</Badge> | Find Instagram account IDs for running Instagram ads |
| `list_meta_pixels` | <Badge color="green">Read</Badge> | View Meta Pixels for conversion tracking setup |
| `get_meta_ad_creatives` | <Badge color="green">Read</Badge> | See ad creatives, copy, and media URLs |
| `list_meta_lead_forms` | <Badge color="green">Read</Badge> | Browse lead generation forms |
| `get_meta_lead_form_submissions` | <Badge color="green">Read</Badge> | View lead data collected from Meta lead forms |

</Expandable>

## TikTok Ads Tools (31)

<Expandable title="View all 31 TikTok Ads tools">
...
| ...and 3 more | | Additional TikTok tools |
