...
icon: "arrows-spin"
keywords: ["workflows", "campaign creation", "optimization", "automation"]
---
...
2. switch_primary_account (if managing multiple accounts) → activate one account (account_id) or several at once (account_ids)
...
```python Daily Performance Brief
schedule_brief(
