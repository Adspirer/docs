...
description: "How the Adspirer performance marketing agent works in Claude Code. Subagent architecture, skills, slash commands, memory, and the agent loop explained."
