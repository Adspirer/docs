---
title: "Run the Adspirer Marketing Agent in OpenClaw"
sidebarTitle: "OpenClaw Agent"
description: "How the Adspirer advertising agent runs inside OpenClaw: bundled SKILL.md file, zero-config setup, claw.json manifest, tool groups, and safety model."
...
|-----------|------|---------|
| **MCP Server** | Plugin config | 300+ advertising tools via OAuth |
...
- **300+ tools documented** — every parameter, every edge case
