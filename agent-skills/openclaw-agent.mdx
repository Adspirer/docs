...
description: "How the Adspirer advertising agent works inside OpenClaw. Bundled skill file, zero-config setup, claw.json manifest, tool groups, and built-in safety model."
