...
This skill contains the complete [Tool Catalog](/agent-skills/tools) (400+ tools) and all [Core Workflows](/agent-skills/workflows).
...
3. Runs platform-specific waste analysis:
   ...
   - Amazon: `analyze_amazon_wasted_spend`
